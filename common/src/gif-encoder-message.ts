...
export type GifEncoderRequestMessage = EncodeGifInWorkerMessage;

export type GifEncoderResponseMessage = EncodedGifFromWorkerMessage | EncodeGifErrorFromWorkerMessage;
